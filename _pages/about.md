...
My primary research areas include chip implementation, architecture design and system optimization to improve energy efficiency of different-size computing systems including IoT devices, cloud servers, etc. My broader interests include emerging technologies and evolving applications that could ultimately lead to the next-generation green computers.
